...
static inline void *mdf_heap_malloc(size_t size)
{
    return heap_caps_malloc(size, MALLOC_CAP_DEFAULT | MALLOC_CAP_INTERNAL);
}
static inline void *mdf_heap_calloc(size_t n, size_t size)
{
    return heap_caps_calloc(n, size, MALLOC_CAP_DEFAULT | MALLOC_CAP_INTERNAL);
}
static inline void *mdf_heap_realloc(void *ptr, size_t size)
{
